 ...
 * WIFI Settings
 **************************/
const char* WIFI_SSID = "FBI Surveillance Van #192601";
const char* WIFI_PWD = "deepbutter800";
...
const char *api_key ="CQ1P1FHDPMU869W0";                  //Your own thingspeak api_key
 ...
 * Begin Settings
 **************************/
#define TZ              -6       // (utc+) TZ in hours (Coordinated Universal Time)
...
const boolean IS_METRIC = false;//true = Metric System OR false = imperial system
// Add your own thingpulse ID 
String OPEN_WEATHER_MAP_APP_ID = "464daeda4dc53a7cfd5a45545406fe44"; //Input Own OpenWeatherMap API_KEY
String OPEN_WEATHER_MAP_LOCATION = "Murray,KY,US"; //Zurich,CH <--old
